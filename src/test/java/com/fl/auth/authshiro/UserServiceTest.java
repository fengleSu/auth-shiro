...
public class UserServiceTest {
    ...
    public void testRegist(){
        ...
        Assert.assertEquals(emailEmptyVo.getResult(), Result.FAILED);
        ...
        Assert.assertEquals(usernameEmptyVo.getResult(), Result.FAILED);
        ...
        Assert.assertEquals(passwordEmptyVo.getResult(), Result.FAILED);
        ...
        Assert.assertEquals(repasswordEmptyVo.getResult(), Result.FAILED);
        ...
        Assert.assertEquals(passwordInconsistentEmptyVo.getResult(), Result.FAILED);
    ...
    public void testLogin(){
        ...
        Assert.assertEquals(userNotExistVo.getResult(), Result.FAILED);
